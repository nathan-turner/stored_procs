...
source0 tinyint /*=11*/ , popu varchar(40) /*=' '*/ ,
spec varchar(80), /*= ' '*/
locum tinyint, -- 0
...
begin
	...
	call AddAContact (ctid,name0,title,company,phone,ext1,fax,ext2,
		...
		st_code,url,2 /* ctct_type */ ,status0,user_mod,date_mod,0);
	insert into lstclients (cli_xid,cli_ctct_id,cli_sys,cli_beds,cli_grp,cli_emp_id,
		...
		cli_source,cli_population,cli_specialty,cli_locumactive,cli_fed_tax)
	values 
		(xid,ctid,sys,beds,grp,emp_id,status0,user_mod,date_mod,user_mod,date_mod,
		 source0,popu,spec,locum,fedtax);
